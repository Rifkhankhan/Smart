  ...
  const [searchQuery, setSearchQuery] = useState("");
    ...
    const services = [
      ...
      // Food Making
      {
          ...
          contact: '2758569360',
          address: '45 Main Road, Palamunai',
          description: 'Delicious home-cooked meals made with care and quality ingredients.',
          ratings: 4.5,
          images: [
    ...
    },
    {
      ...
      },
      {
          ...
          description: 'Professional event planning for weddings, parties, and more.',
          ratings: 4.7,
          images: [
            ...
            renderSectionHeader={({ section: { title, data } }) => (
                <View style={styles.headerContainer}>
                  <View style={styles.sectionHeaderContainer}>
                    ...
                    <TouchableOpacity  onPress={() => navigation.navigate('ViewServicesByCategory',{
                      data:data
                    })}>
                   {data?.length > 2  &&   <Text style={styles.moreHeader}>
                      View More
                      </Text>}
                    </TouchableOpacity>
                  </View>
