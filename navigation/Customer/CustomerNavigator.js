...
const HomeOverViewScreen = React.memo(() => (
  <Stack.Navigator>
    <Stack.Screen
      name="Home"
      component={Home}
      options={{
        ...
        headerTitle: '',
        headerLeft: () => (
          <Text style={{ color: 'white', fontFamily: 'monospace', fontSize: 30, paddingInline: 10 }}>
            Smart
          </Text>
        ),
        headerRight: ({ color }) => <IconButton name="search" color="white" size={24} />
      }}
    />
    <Stack.Screen
      name="ProductDetails"
...
const getCardOptions = {
  tabBarIcon: ({ color, size }) => <AntDesign name="shoppingcart" size={32} color={color} />
}
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={getHomeOverViewOptions}
      />
      <Tab.Screen
        name="Card"
        component={Card}
    ...
    <Stack.Navigator initialRouteName="Account">
      <Stack.Screen
        ...
        options={{
          ...
          headerStyle: { backgroundColor: '#8B008B' },
          headerTintColor: 'white',
          headerRight: () => <IconButton name="settings-outline" color="white" size={24} />,
          headerLeft: () => <IconButton name="add" size={24} color="red" backgroundColor={true} />
        }}
      />
      <Stack.Screen
        name="Orders"
