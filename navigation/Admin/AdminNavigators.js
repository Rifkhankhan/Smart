...
import { getProducts, getShops, getUsers } from "../../utils/Subscribefunctions/Admin";
import { getUserCarts } from "../../utils/Subscribefunctions/Client";
import colors from "../../constants/colors";
import commonStyles from "../../constants/commonStyles";
...
const CustomerListPage = React.lazy(() => import("../../screens/CustomersListPage"));
...
const ProductListPage = React.lazy(() => import("../../screens/product/ProductListPage"));
const CreateProduct = React.lazy(() => import("../../screens/product/CreateProduct"));
const ViewProduct = React.lazy(() => import("../../screens/product/ViewProduct"));
const EditProduct = React.lazy(() => import("../../screens/product/EditProduct"));
...
export const AdminNavigator = () => {
  ...
  useEffect(() => {
    ...
    const getUserCartsAction = getUserCarts(getDatabase(app), cartIdsRef, [usersRef, shopsRef, productsRef, cartIdsRef]);
    dispatch(getUserCartsAction);
  ...
  <Stack.Navigator initialRouteName="AdminHome">
    <Stack.Screen
      ...
      options={{
        ...
        headerTitle: "Smart",
        headerLeft: () => (
          <Text style={{ color: "white", fontFamily: "monospace", fontSize: 30 }}>
            Smart
          </Text>
        ),
